...
class _ChurchDetailPageState extends State<ChurchDetailPage> {
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (!showForm) ...[
                    ...
                    Text(
                      "Pilih tipe radar yang ingin dibuat:",
                    ...
                    _buildRadarOption(
                      ...
                      subtitle:
                          "Beritahu umat lain bahwa kamu akan Misa di sini.",
                      onTap: () {
                    ...
                    _buildRadarOption(
                      ...
                      onTap: () async {
                        ...
                        // 2. Select Friend
                        final selectedFriend = await navigator
                        ...
                        messenger.showSnackBar(
                          const SnackBar(
                            content: Text("Mengirim undangan..."),
                        ...
                        try {
                          ...
                          int targetDayVal = (schedule.dayOfWeek == 0)
                              ? 7
                              : schedule.dayOfWeek;
                          ...
                          int daysToAdd =
                              (targetDayVal - currentDayVal + 7) % 7;
                          ...
                          await _radarService.createPersonalRadar(
                            ...
                            churchName:
                                widget.churchData['name'] ?? 'Gereja Ini',
                            scheduleTime: scheduleDate,
                            message:
                                "Mengajak misa bersama.", // Default Message
                          );
                          ...
                          if (mounted) {
                            messenger.showSnackBar(
                              SnackBar(
                                content: Text(
                                  "Undangan dikirim ke ${selectedFriend['full_name'] ?? 'Teman'}!",
                                ),
                            ...
                            : () async {
                                ...
                                try {
                                  ...
                                  messenger.showSnackBar(
                                    const SnackBar(
                                      content: Text(
                                        "Radar berhasil dibuat! Teman-temanmu akan diberitahu.",
                                      ),
                                      backgroundColor: Colors.green,
                                    ),
                                  );
                ...
                children: [
                    ...
                    children: [
                      ...
                      Expanded(
                        child: _buildActionButton(
                          Icons.public,
                          "Website",
                          () => _launchExternal(webUrl ?? socialUrl),
                        ),
                      ),
                    ],
                  ),
                  ...
                  if (_isLoading)
                    const Padding(
                      ...
                      child: Center(
                        child: CircularProgressIndicator(color: kPrimaryBrand),
                      ),
                    )
  ...
  Widget _buildScheduleCard(Schedule s) {
    ...
    final time = s.timeStart.length > 5
