...
class CreateYVariablesBuilder {
  ...
  CreateYVariablesBuilder(
    this._dataConnect, {
    required this.content,
    required this.authorId,
    required this.createdAt,
  });
  Deserializer<CreateYData> dataDeserializer = (dynamic json) =>
      CreateYData.fromJson(jsonDecode(json));
  Serializer<CreateYVariables> varsSerializer = (CreateYVariables vars) =>
  ...
  MutationRef<CreateYData, CreateYVariables> ref() {
    CreateYVariables vars = CreateYVariables(
      content: content,
      authorId: authorId,
      createdAt: createdAt,
    );
...
class CreateYYInsert {
  ...
  CreateYYInsert({required this.id});
}
...
class CreateYData {
  ...
  CreateYData({required this.y_insert});
}
...
class CreateYVariables {
  ...
  @override
  int get hashCode =>
      Object.hashAll([content.hashCode, authorId.hashCode, createdAt.hashCode]);
