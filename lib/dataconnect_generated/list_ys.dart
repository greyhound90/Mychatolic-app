...
class ListYsVariablesBuilder {
  ...
  Deserializer<ListYsData> dataDeserializer = (dynamic json)  => ListYsData.fromJson(jsonDecode(json));
  ...
  QueryRef<ListYsData, void> ref() {
    ...
    return _dataConnect.query("ListYs", dataDeserializer, emptySerializer, null);
  }
}
...
class ListYsYs {
  ...
  @override
  int get hashCode => Object.hashAll([id.hashCode, content.hashCode, author.hashCode]);
