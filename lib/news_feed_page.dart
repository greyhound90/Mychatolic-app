            ...
            itemBuilder: (context, index) {
              ...
              if (index == _posts.length + 1) {
                return _hasMore
                    ...
                    : const Padding(padding: EdgeInsets.all(40), child: Center(child: Text("Anda sudah mencapai akhir.", style: TextStyle(color: Colors.grey))));
              }
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text("Semoga harimu penuh berkah.", style: GoogleFonts.outfit(color: Colors.white.withValues(alpha: 0.9), fontSize: 14)),
                        ],
                      ),
                      Container(
                  ...
                  Container(
                     ...
                     child: Row(
                       children: [
                         ...
                         Expanded(child: Text("Bacaan Hari Ini: Mat 5:1-12", style: GoogleFonts.outfit(color: Colors.white, fontWeight: FontWeight.w600))),
        ...
        Positioned(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                 BoxShadow(color: const Color(0xFF0088CC).withValues(alpha: 0.15), blurRadius: 20, offset: const Offset(0, 8))
              ],
            ),
            child: Row(
              children: [
                CircleAvatar(radius: 18, backgroundColor: Colors.grey[100], child: const Icon(Icons.edit, color: kPrimary, size: 18)),
                const SizedBox(width: 16),
                Expanded(child: Text("Apa cerita imanmu hari ini?", style: GoogleFonts.outfit(color: kTextMeta, fontSize: 14))),
