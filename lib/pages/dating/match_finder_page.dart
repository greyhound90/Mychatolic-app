...
class _MatchFinderPageState extends State<MatchFinderPage> {
  ...
  List<Map<String, dynamic>> _getMockCandidates() {
    return [
      {
        'id': '1',
        'full_name': 'Maria Fransiska',
        'role': 'umat',
        'avatar_url':
            'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&q=80&w=600',
        'verification_status': 'verified',
        'bio': 'Suka pelayanan di gereja dan paduan suara. 🎵',
      },
      {
        'id': '2',
        'full_name': 'Theresia Yuli',
        'role': 'umat',
        'avatar_url':
            'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&q=80&w=600',
        'verification_status': 'verified',
        'bio': 'Mencari teman diskusi iman. 🙏',
      },
      {
        'id': '3',
        'full_name': 'Agnes Monika',
        'role': 'umat',
        'avatar_url':
            'https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&q=80&w=600',
        'verification_status': 'pending',
        'bio': 'OMK Paroki Katedral.',
      },
    ];
  }
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () {
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text("Filter: 100% Katolik Only")),
              );
            },
