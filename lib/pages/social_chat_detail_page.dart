...
class SocialChatDetailPage extends StatefulWidget {
  ...
  final String? otherUserId; // Added for explicit userId access if needed, mainly for future proofing
...
class _SocialChatDetailPageState extends State<SocialChatDetailPage> with SingleTickerProviderStateMixin {
          ...
          onTap: () {
            ...
            if (userId != null) {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => ProfilePage(userId: userId, isBackButtonEnabled: true),
                ),
              );
            }
          },
  ...
  // 1. Text Bubble
  Widget _buildTextBubble(bool isMe, String content, String? time, bool isRead) {
    return Align(
     ...
     return Align(
       ...
       child: Container(
         ...
         child: Row(
           mainAxisSize: MainAxisSize.min,
           children: [
              Image.asset('assets/beep.png', width: 24, height: 24, fit: BoxFit.contain),
             ...
             Text(
                time != null ? timeago.format(DateTime.parse(time), locale: 'id') : "",
                style: GoogleFonts.outfit(color: _beebPrimary.withValues(alpha: 0.6), fontSize: 10),
             ),
           ],
         ),
       ),
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                shape: BoxShape.circle,
                boxShadow: [BoxShadow(color: AppColors.primaryBrand.withValues(alpha: 0.3), blurRadius: 8, offset: const Offset(0, 4))]
              ),
