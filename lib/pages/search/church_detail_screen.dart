         ...
         children: [
           ...
           Wrap(
             ...
             children: items.map((item) {
               ...
               final borderColor = isJoined ? _brandBlue : _brandBlue.withValues(alpha: 0.3);
               ...
               return InkWell(
                 ...
                 child: Container(
                   ...
                   decoration: BoxDecoration(
                     ...
                     borderRadius: BorderRadius.circular(12),
                     boxShadow: [
                       BoxShadow(color: _brandBlue.withValues(alpha: 0.05), blurRadius: 4, offset: const Offset(0, 2))
                     ]
                   ),
                   child: Row(
