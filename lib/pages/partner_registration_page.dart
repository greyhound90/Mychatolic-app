...
class _PartnerRegistrationPageState extends State<PartnerRegistrationPage> {
  ...
  Future<void> _submitRegistration(
    ...
    if (_celebretImage == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text("Mohon upload Foto Surat Celebret / Surat Tugas"),
        ),
      );
      return;
    }
        ...
        await _supabase
            ...
            .update({
              ...
              'verification_doc_url':
                  docUrl, // Reusing this column per Admin request
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: DropdownButtonHideUnderline(
                child: DropdownButton<String>(
                  ...
                  hint: Text(
                    "Pilih Peran",
                    style: GoogleFonts.outfit(color: metaColor),
                  ),
                  isExpanded: true,
            ...
            // 2. UPLOAD CELEBRET
            Text(
              "DOKUMEN VALIDASI (Surat Celebret / Tugas)",
              style: GoogleFonts.outfit(
                color: metaColor,
                fontSize: 12,
                fontWeight: FontWeight.bold,
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: _celebretImage != null
                      ? DecorationImage(
                          image: FileImage(_celebretImage!),
                          fit: BoxFit.cover,
                        )
                      : null,
                ),
